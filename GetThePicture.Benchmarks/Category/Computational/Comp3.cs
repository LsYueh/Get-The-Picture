...
public class Comp3Benchmark
{
    ...
    private static readonly byte[] uintBuffer = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1F];
    private static readonly ulong uintValue = 1;

    private static readonly PicMeta intPic = PicMeta.Parse("S9(18)");
    private static readonly byte[] intBuffer = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1C];
    private static readonly long intValue = 1;
    ...
    public void Comp3_Write_Integer()
    {
        ...
        [Benchmark]
    public void Comp3_Read_Signed_Integer()
    {
    ...
    [Benchmark]
    public void Comp3_Write_Signed_Integer()
    {
