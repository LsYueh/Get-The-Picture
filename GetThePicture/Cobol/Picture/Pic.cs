...
public static partial class Pic
{
    ...
    public static PicClause Parse(string input, PicSemantic semantic = PicSemantic.None, ComputationalItem Comp = ComputationalItem.None)
    {
